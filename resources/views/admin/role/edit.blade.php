           ...
           <form action="{{ route('roles.update', [ 'id' => $role->id]) }}" method="POST" enctype="multipart/form-data" style="width: 100%">
                <div class="col-md-12">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" value="{{ $role->name }}" name="name" class="form-control" id="name"  placeholder="nhập tên role">
                        <span>
                            @error('name')
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="form-control"  name="display_name" id="display_name" rows="3">{{ $role->display_name }}</textarea>
                        <span>
                            @error('display_name')
                                <div class="alert alert-danger">{{ $message }}</div>
                            @enderror
                        ...
                        <div class="card text-bg-primary mb-3 col-md-12 parent">
                            ...
                            <div class="row">
                                ...
                                <div class="card-body text-primary col-md-3">
                                    <h5 class="card-title">
                                        <label>
                                            <input type="checkbox" class="checkbox_child" name="permission[]" value="{{$childRole->id}}"{{$permission->contains('id',$childRole->id) ? 'checked' : '' }}>
                                        </label>
                                        {{$childRole->name}}
                                    </h5>
                                </div>
